...
var sr = (e, t, s) =>
  t in e ? tr(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (e[t] = s);
...
var R = nr,
  ir = typeof ue == 'object' && ue && ue.Object === Object && ue,
  wn = ir,
  rr = wn,
  or = typeof self == 'object' && self && self.Object === Object && self,
  ar = rr || or || Function('return this')(),
  Y = ar,
  cr = Y,
  ur = cr.Symbol,
  Re = ur,
  rs = Re,
  kn = Object.prototype,
  lr = kn.hasOwnProperty,
  dr = kn.toString,
  $e = rs ? rs.toStringTag : void 0;
function pr(e) {
  var t = lr.call(e, $e),
    s = e[$e];
  try {
...
function qr(e, t) {
  if (Ir(e)) return !1;
  var s = typeof e;
  return s == 'number' || s == 'symbol' || s == 'boolean' || e == null || Or(e)
    ? !0
    : Mr.test(e) || !Lr.test(e) || (t != null && e in Object(t));
}
var Pt = qr;
function Nr(e) {
  var t = typeof e;
...
var Pe = Xo,
  Qo = Pe;
function ea(e, t) {
  for (var s = e.length; s--; ) if (Qo(e[s][0], t)) return s;
  return -1;
}
var it = ea,
  ta = it,
...
var Qa = Xa,
  ...
  ic = nc;
function rc(e, t) {
  for (var s = -1, n = e == null ? 0 : e.length, i = Array(n); ++s < n; ) i[s] = t(e[s], s, e);
  return i;
}
var Lt = rc,
  ps = Re,
  ...
  cc = st,
  uc = 1 / 0,
  gs = ps ? ps.prototype : void 0,
  hs = gs ? gs.toString : void 0;
function _n(e) {
  if (typeof e == 'string') return e;
  if (ac(e)) return oc(e, _n) + '';
  if (cc(e)) return hs ? hs.call(e) : '';
  var t = e + '';
...
var wc = Dc,
  ...
  kc = ee,
  xn = Object.prototype,
  Fc = xn.hasOwnProperty,
  Ac = xn.propertyIsEnumerable,
  Cc = fs(
    (function () {
      return arguments;
    })()
...
function xc(e, t) {
  ...
  return (
    (t = t ?? _c),
    !!t && (s == 'number' || (s != 'symbol' && Ec.test(e))) && e > -1 && e % 1 == 0 && e < t
  );
}
var ut = xc,
  Sc = 9007199254740991;
...
function Mc(e, t, s) {
  ...
  for (var n = -1, i = t.length, r = !1; ++n < i; ) {
    var o = Lc(t[n]);
    if (!(r = e != null && s(e, o))) break;
    e = e[o];
  }
  return r || ++n != i
    ? r
    : ((i = e == null ? 0 : e.length), !!i && Oc(i) && Ic(o, i) && (jc(e) || Pc(e)));
}
var Sn = Mc,
  qc = Br,
  Nc = Sn;
...
function Gu(e) {
  var t = e && e.constructor,
    s = (typeof t == 'function' && t.prototype) || Hu;
  return e === s;
}
var Nt = Gu;
function Vu(e, t) {
...
function nl(e) {
  if (!Qu(e)) return el(e);
  var t = [];
  for (var s in Object(e)) sl.call(e, s) && s != 'constructor' && t.push(s);
  return t;
}
var Bn = nl,
  il = Fn,
...
function ml(e, t) {
  return function (s, n) {
    if (s == null) return s;
    if (!fl(s)) return e(s, n);
    for (
      var i = s.length, r = t ? i : -1, o = Object(s);
      (t ? r-- : ++r < i) && n(o[r], r, o) !== !1;
...
function zl(e, t) {
  t = $l(t, e);
  for (var s = 0, n = t.length; e != null && s < n; ) e = e[Bl(t[s++])];
...
var cd = ad;
function ud(e, t) {
  for (var s = -1, n = t.length, i = e.length; ++s < n; ) e[i + s] = t[s];
  return e;
}
var Rn = ud,
  Ds = Re,
  ld = ct,
  dd = I,
  ws = Ds ? Ds.isConcatSpreadable : void 0;
function pd(e) {
...
var On = qd,
  ...
  l1 = Ee(_t),
  ae = qn;
((kt && ae(new kt(new ArrayBuffer(1))) != Ss) ||
  (Ft && ae(new Ft()) != Cs) ||
  (At && ae(At.resolve()) != _s) ||
  (Ct && ae(new Ct()) != Es) ||
  (_t && ae(new _t()) != xs)) &&
...
var Nn = ae,
  ...
  D1 = '[object Set]',
  w1 = Object.prototype,
  k1 = w1.hasOwnProperty;
function F1(e) {
  if (e == null) return !0;
  if (
    f1(e) &&
    (h1(e) || typeof e == 'string' || typeof e.splice == 'function' || m1(e) || b1(e) || g1(e))
  )
    return !e.length;
  var t = p1(e);
  if (t == v1 || t == D1) return !e.size;
  if (y1(e)) return !d1(e).length;
  for (var s in e) if (k1.call(e, s)) return !1;
  return !0;
}
var ze = F1;
function A1(e) {
...
var C1 = A1,
  ...
  $1 = S1,
  B1 = ge,
  z1 = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,
  T1 = '\\u0300-\\u036f',
  R1 = '\\ufe20-\\ufe2f',
  P1 = '\\u20d0-\\u20ff',
  j1 = T1 + R1 + P1,
...
var Un = X1;
function Q1(e, t, s, n) {
  for (var i = e.length, r = s + (n ? 1 : -1); n ? r-- : ++r < i; ) if (t(e[r], r, e)) return r;
  return -1;
}
var ep = Q1;
function tp(e) {
...
var sp = tp;
function np(e, t, s) {
  for (var n = s - 1, i = e.length; ++n < i; ) if (e[n] === t) return n;
  return -1;
}
var ip = np,
  rp = ep,
...
var Hn = Cp,
  ...
  Jn = zp + '?',
  Xn = '[' + $p + ']?',
  Rp = '(?:' + Tp + '(?:' + [Vn, Yn, Zn].join('|') + ')' + Xn + Jn + ')*',
  Pp = Xn + Jn + Rp,
  jp = '(?:' + [Vn + Et + '?', Et, Yn, Zn, Bp].join('|') + ')',
  Ip = RegExp(xt + '(?=' + xt + ')|' + jp + Pp, 'g');
function Op(e) {
  return e.match(Ip) || [];
}
var Lp = Op,
...
var Qn = Kp,
  ...
  Yp = ge;
function Zp(e, t, s) {
  if (((e = Yp(e)), e && (s || t === void 0))) return Up(e);
  if (!e || !(t = Wp(t))) return e;
  var n = $s(e),
    i = $s(t),
    r = Vp(n, i),
    o = Gp(n, i) + 1;
...
var Jp = Zp;
const Xp = (e) => (e ? N1(Kn(Jp(e.replace(/[\s\./_]+/g, '-'), '-'))) : '');
function Qp(e, t) {
...
function mg(e, t) {
  ...
  if (s instanceof pg) {
    var n = s.__data__;
    if (!gg || n.length < fg - 1) return n.push([e, t]), (this.size = ++s.size), this;
...
function Je(e) {
  var t = -1,
    s = e == null ? 0 : e.length;
  for (this.__data__ = new Sg(); ++t < s; ) this.add(e[t]);
}
Je.prototype.add = Je.prototype.push = $g;
Je.prototype.has = Bg;
var si = Je;
function zg(e, t) {
  for (var s = -1, n = e == null ? 0 : e.length; ++s < n; ) if (t(e[s], s, e)) return !0;
  return !1;
}
var Tg = zg;
function Rg(e, t) {
...
function Mg(e, t, s, n, i, r) {
  ...
  var p = -1,
    d = !0,
    f = s & Lg ? new Pg() : void 0;
  for (r.set(e, t), r.set(t, e); ++p < a; ) {
    var y = e[p],
      E = t[p];
    if (n) var k = o ? n(E, y, p, t, e, r) : n(y, E, p, e, t, r);
    if (k !== void 0) {
      if (k) continue;
      d = !1;
      break;
    ...
    if (f) {
      if (
        !jg(t, function (O, h) {
          if (!Ig(f, h) && (y === O || i(y, O, s, n, r))) return f.push(h);
        })
      ) {
        d = !1;
        break;
...
var Ut = Hg,
  ...
  uh = '[object DataView]',
  Ts = Bs ? Bs.prototype : void 0,
  bt = Ts ? Ts.valueOf : void 0;
function lh(e, t, s, n, i, r, o) {
  switch (s) {
    ...
    case rh:
      var c = n & Jg;
      if ((a || (a = Zg), e.size != t.size && !c)) return !1;
      var u = o.get(e);
      if (u) return u == t;
      (n |= Xg), o.set(e, t);
      ...
      return o.delete(e), l;
    case ah:
      if (bt) return bt.call(e) == bt.call(t);
  }
  return !1;
}
var dh = lh,
...
function zh(e, t, s, n, i, r) {
  ...
  for (var p = c; p--; ) {
    var d = a[p];
    if (!(o ? d in t : Bh.call(t, d))) return !1;
  }
  var f = r.get(e),
    y = r.get(t);
  ...
  for (var k = o; ++p < c; ) {
    ...
    var O = e[d],
      h = t[d];
    if (n) var _ = o ? n(h, O, d, t, e, r) : n(O, h, d, e, t, r);
  ...
  if (E && !k) {
    ...
    $ != v &&
      'constructor' in e &&
      'constructor' in t &&
      !(typeof $ == 'function' && $ instanceof $ && typeof v == 'function' && v instanceof v) &&
      (E = !1);
  }
...
function Mh(e, t, s, n, i, r) {
  ...
  if (!(s & Oh)) {
    var f = l && qs.call(e, '__wrapped__'),
      y = p && qs.call(t, '__wrapped__');
    if (f || y) {
      var E = f ? e.value() : e,
        k = y ? t.value() : t;
...
function Gh(e, t, s, n) {
  ...
  for (; ++i < r; ) {
    ...
    if (o && a[2]) {
      ...
      var p = new Kh();
      if (n) var d = n(u, l, c, e, t, p);
      if (!(d === void 0 ? Wh(l, u, Uh | Hh, n, p) : d)) return !1;
    }
  }
  return !0;
}
...
function kf(e) {
  ...
  return (
    (t.__actions__ = wf(e.__actions__)),
...
function et(e) {
  if (Ef(e) && !_f(e) && !(e instanceof Af)) {
    ...
    if ($f.call(e, '__wrapped__')) return xf(e);
  }
  return new Gs(e);
}
...
function jf(e) {
  var t = Rf(e),
    s = Pf[t];
  if (typeof s != 'function' || !(t in zf.prototype)) return !1;
  if (e === s) return !0;
  var n = Tf(s);
  return !!n && e === n[0];
}
...
function Hf(e) {
  return Of(function (t) {
    ...
    for (e && t.reverse(); n--; ) {
      ...
      if (i && !o && Dt(r) == 'wrapper') var o = new Vs([], !0);
    }
    for (n = o ? n : s; ++n < s; ) {
      r = t[n];
      var a = Dt(r),
        c = a == 'wrapper' ? Lf(r) : void 0;
      c && Ys(c[0]) && c[1] == (Wf | Nf | Kf | Uf) && !c[4].length && c[9] == 1
        ? (o = o[Dt(c[0])].apply(o, c[3]))
        : (o = r.length == 1 && Ys(r) ? o[a]() : o.thru(r));
    }
    return function () {
      var u = arguments,
        l = u[0];
      if (o && u.length == 1 && Mf(l)) return o.plant(l).value();
      for (var p = 0, d = s ? t[p].apply(this, u) : l; ++p < s; ) d = t[p].call(this, d);
      return d;
    };
  });
}
...
`
  ...
  Qf = (e) => e.replace(Xf, ''),
  me = (e) => e.replace(/<!--[\s\S]*?-->/g, ''),
  pt = (e) => e.replace(/&\S+?;/g, ''),
  mi = `[\\–\\-\\(\\)_\\[\\]’“”"'.?!:;,¿¡«»‹›—×+&<>]+`,
  em = new RegExp('^' + mi),
  tm = new RegExp(mi + '$'),
  yi = (e) => e.replace(em, '').replace(tm, ''),
  sm = (e) => {
    if (((e = se([fe, me, Yt, qe, pt, fi, Qf])(e)), e === '')) return [];
    let t = e.split(/\s/g);
...
class om {
  ...
  constructor() {
    (this.irregularSingles = {}),
      ...
      (this.uncountables = nm),
      (this.pluralizationRules = rm),
  ...
  get(t) {
    ...
    if (
      (this.irregularPlurals.hasOwnProperty(s) && this.restoreCase(t, s),
      this.irregularSingles.hasOwnProperty(s) && this.restoreCase(t, this.irregularSingles[s]),
      this.uncountables.hasOwnProperty(s))
    )
      return t;
    let n = this.pluralizationRules.length;
    for (; n--; ) {
      const i = this.pluralizationRules[n];
      if (i[0].test(t)) return this.replace(t, i);
    }
    return t;
  }
  /**
...
function gm(e, t) {
  ...
  return (
    (i.shortcodes =
      (s = (n = i.l10n) === null || n === void 0 ? void 0 : n.shortcodes) !== null && s !== void 0
        ? s
        : []),
    i.shortcodes &&
      i.shortcodes.length &&
      (i.shortcodesRegExp = new RegExp(
        '\\[\\/?(?:' + i.shortcodes.join('|') + ')[^\\]]*?\\]',
        'g'
      )),
    (i.type = e),
    i.type !== 'characters_excluding_spaces' &&
      i.type !== 'characters_including_spaces' &&
      (i.type = 'words'),
    i
  );
}
function hm(e, t, s) {
  ...
  return (
    ...
    (e =
      ...
      `
`),
    (n = (i = e.match(t)) === null || i === void 0 ? void 0 : i.length) !== null && n !== void 0
      ? n
      : 0
  );
}
...
var bm = ym;
function vm(e, t, s) {
  for (var n = -1, i = e == null ? 0 : e.length; ++n < i; ) if (s(t, e[n])) return !0;
  return !1;
}
var Dm = vm,
  wt = Ln,
...
function Tm(e, t, s) {
  ...
  e: for (; ++n < r; ) {
    ...
    if (((l = s || l !== 0 ? l : 0), o && p === p)) {
      ...
      t && c.push(p), a.push(l);
    } else i(c, p, s) || (c !== a && c.push(p), a.push(l));
  }
  return a;
}
var Rm = Tm,
...
function hy(e, t, s, n) {
  ...
  var i = e.length;
  return (
    s < 0 && (s = gy(i + s, 0)), ly(e) ? s <= i && e.indexOf(t, s) > -1 : !!i && cy(e, t, s) > -1
  );
}
var B = hy;
const fy = (e) => {
  ...
  for (let o = 0; o < n * n; o++) R(i[o]) || r(i[o].split(' '));
...
(function (e, t) {
  (function (s) {
    ...
    function q(g, m) {
      for (var b = g.length, x = []; b--; ) x[b] = m(g[b]);
      return x;
    }
    function Z(g, m) {
      var b = g.split('@'),
    ...
    function Ue(g) {
      return q(g, function (m) {
        ...
        return (
          m > 65535 &&
            ((m -= 65536), (b += z(((m >>> 10) & 1023) | 55296)), (m = 56320 | (m & 1023))),
          (b += z(m)),
          b
        );
      }).join('');
    ...
    function ve(g, m, b) {
      var x = 0;
      for (g = b ? v(g / d) : g >> 1, g += v(g / m); g > ($ * l) >> 1; x += c) g = v(g / $);
      return v(x + (($ + 1) * g) / (g + p));
    }
    function re(g) {
      var m = [],
    ...
    function He(g) {
      ...
      for (x = S = K.length, S && K.push(E); x < H; ) {
        for (N = a, T = 0; T < H; ++T) (j = g[T]), j >= m && j < N && (N = j);
        for (
          Q = x + 1, N - m > v((a - b) / Q) && P('overflow'), b += (N - m) * Q, m = N, T = 0;
          T < H;
          ++T
        )
          if (((j = g[T]), j < m && ++b > a && P('overflow'), j == m)) {
            for (U = b, G = c; (J = G <= L ? u : G >= L + l ? l : G - L), !(U < J); G += c)
              (ft = U - J), (oe = c - J), K.push(z(be(J + (ft % oe), 0))), (U = v(ft / oe));
    ...
    if (
      ...
      else for (X in o) o.hasOwnProperty(X) && (n[X] = o[X]);
    else s.punycode = o;
  })(ue);
})(my, tt);
var yy = {
...
var vy = function (e, t, s, n) {
    ...
    o > 0 && a > o && (a = o);
    for (var c = 0; c < a; ++c) {
      var u = e[c].replace(r, '%20'),
        l = u.indexOf(s),
        p,
        d,
        f,
        y;
      l >= 0 ? ((p = u.substr(0, l)), (d = u.substr(l + 1))) : ((p = u), (d = '')),
        (f = decodeURIComponent(p)),
        (y = decodeURIComponent(d)),
        by(i, f) ? (Array.isArray(i[f]) ? i[f].push(y) : (i[f] = [i[f], y])) : (i[f] = y);
    }
    return i;
  },
  Be = function (e) {
            ...
            .map(function (i) {
              ...
              return Array.isArray(e[i])
                ? e[i]
                    ...
                    .join(t)
                : r + encodeURIComponent(Be(e[i]));
            })
            .join(t)
        : n
          ? encodeURIComponent(Be(n)) + s + encodeURIComponent(Be(e))
          : ''
    );
  };
...
`,
  ...
  Bt = Te;
function Ne(e, t, s) {
  if (e && V.isObject(e) && e instanceof W) return e;
  var n = new W();
  return n.parse(e, t, s), n;
}
W.prototype.parse = function (e, t, s) {
  if (!V.isString(e)) throw new TypeError("Parameter 'url' must be a string, not " + typeof e);
  var n = e.indexOf('?'),
    i = n !== -1 && n < e.indexOf('#') ? '?' : '#',
    r = e.split(i),
    o = /\\/g;
    ...
    if (c)
      return (
        ...
        c[2]
          ? ((this.search = c[2]),
            t
              ? (this.query = Bt.parse(this.search.substr(1)))
  ...
  if (!$t[u] && (p || (u && !we[u]))) {
    ...
    var E, k;
    d === -1 ? (k = a.lastIndexOf('@')) : (k = a.lastIndexOf('@', d)),
      k !== -1 && ((E = a.slice(0, k)), (a = a.slice(k + 1)), (this.auth = decodeURIComponent(E))),
      (d = -1);
    ...
    this.hostname.length > Ey
      ? (this.hostname = '')
      : (this.hostname = this.hostname.toLowerCase()),
      O || (this.hostname = wy.toASCII(this.hostname));
    var ye = this.port ? ':' + this.port : '',
      Ue = this.hostname || '';
    (this.host = Ue + ye),
      (this.href += this.host),
      O &&
  ...
  if (
    (re !== -1
      ? ((this.search = a.substr(re)),
        (this.query = a.substr(re + 1)),
        t && (this.query = Bt.parse(this.query)),
        (a = a.slice(0, re)))
      : t && ((this.search = ''), (this.query = {})),
    a && (this.pathname = a),
...
W.prototype.format = function () {
  ...
  this.host
    ...
    this.query &&
      V.isObject(this.query) &&
      Object.keys(this.query).length &&
      (r = Bt.stringify(this.query));
  var o = this.search || (r && '?' + r) || '';
  return (
    t && t.substr(-1) !== ':' && (t += ':'),
    this.slashes || ((!t || we[t]) && i !== !1)
...
W.prototype.resolveObject = function (e) {
  ...
  if (e.slashes && !e.protocol) {
    ...
    return (
      we[s.protocol] && s.hostname && !s.pathname && (s.path = s.pathname = '/'),
      (s.href = s.format()),
      s
    );
  }
  ...
  var y = s.pathname && s.pathname.charAt(0) === '/',
    ...
    k = E || y || (s.host && e.pathname),
    O = k,
    h = (s.pathname && s.pathname.split('/')) || [],
    _ = (e.pathname && e.pathname.split('/')) || [],
    $ = s.protocol && !we[s.protocol];
  if (
    ($ &&
      ((s.hostname = ''),
      (s.port = null),
      s.host && (h[0] === '' ? (h[0] = s.host) : h.unshift(s.host)),
      (s.host = ''),
      e.protocol &&
        ((e.hostname = null),
        (e.port = null),
    ...
    return (
      (s.search = e.search),
      (s.query = e.query),
      (!V.isNull(s.pathname) || !V.isNull(s.search)) &&
  ...
  for (
    var z = h.slice(-1)[0],
      X = ((s.host || e.host || h.length > 1) && (z === '.' || z === '..')) || z === '',
      P = 0,
      q = h.length;
    q >= 0;
    q--
    ...
    (z = h[q]),
      z === '.' ? h.splice(q, 1) : z === '..' ? (h.splice(q, 1), P++) : P && (h.splice(q, 1), P--);
  if (!k && !O) for (; P--; P) h.unshift('..');
  k && h[0] !== '' && (!h[0] || h[0].charAt(0) !== '/') && h.unshift(''),
    X && h.join('/').substr(-1) !== '/' && h.push('');
  ...
  return (
    (k = k || (s.host && h.length)),
    k && !Z && h.unshift(''),
    h.length ? (s.pathname = h.join('/')) : ((s.pathname = null), (s.path = null)),
    (!V.isNull(s.pathname) || !V.isNull(s.search)) &&
      (s.path = (s.pathname ? s.pathname : '') + (s.search ? s.search : '')),
...
function nn(e, t) {
  return function (n, i, r) {
    ...
    if (a[n]) {
      ...
      l === u.length ? (u[l] = c) : u.splice(l, 0, c),
        a.__current.forEach((p) => {
...
function Ve(e, t) {
  ...
  return function (i, r) {
    const o = e[t];
    if (!Qt(i) || (!s && !Ci(r))) return;
    if (!o[i]) return 0;
    let a = 0;
    if (s)
      (a = o[i].handlers.length),
        (o[i] = {
          runs: o[i].runs,
          handlers: [],
        });
...
function on(e, t) {
  ...
  return function (i) {
    ...
    for (var a = arguments.length, c = new Array(a > 1 ? a - 1 : 0), u = 1; u < a; u++)
      c[u - 1] = arguments[u];
    if (!o || !o.length) return s ? c[0] : void 0;
    const l = {
      name: i,
      currentIndex: 0,
    };
    ...
    if ((r.__current.pop(), s)) return c[0];
  };
}
function an(e, t) {
  return function () {
    ...
    const r = e[t];
    return (n =
      (i = r.__current[r.__current.length - 1]) === null || i === void 0 ? void 0 : i.name) !==
      null && n !== void 0
      ? n
      : null;
  };
...
function un(e, t) {
  return function (n) {
    const i = e[t];
    if (Qt(n)) return i[n] && i[n].runs ? i[n].runs : 0;
  };
}
class Ty {
  constructor() {
    (this.actions = /* @__PURE__ */ Object.create(null)),
      ...
      (this.addAction = nn(this, 'actions')),
      (this.addFilter = nn(this, 'filters')),
      (this.removeAction = Ve(this, 'actions')),
      (this.removeFilter = Ve(this, 'filters')),
      (this.hasAction = rn(this, 'actions')),
      (this.hasFilter = rn(this, 'filters')),
      (this.removeAllActions = Ve(this, 'actions', !0)),
      (this.removeAllFilters = Ve(this, 'filters', !0)),
      (this.doAction = on(this, 'actions')),
      (this.applyFilters = on(this, 'filters', !0)),
      (this.currentAction = an(this, 'actions')),
      (this.currentFilter = an(this, 'filters')),
      (this.doingAction = cn(this, 'actions')),
      (this.doingFilter = cn(this, 'filters')),
      (this.didAction = un(this, 'actions')),
      (this.didFilter = un(this, 'filters'));
  }
}
function Ry() {
  return new Ty();
...
function My(e, t) {
  ...
  return t.noFollowDomains.length
    ? (t.noFollowDomains.forEach((i) => {
        B(n.host, i) && (s = !1);
      }),
      s)
    : t.noFollowExcludeDomains.length
      ? ((s = !1),
        t.noFollowExcludeDomains.forEach((i) => {
          B(n.host, i) && (s = !0);
        }),
        s)
      : !1;
...
function Ky(e, t, s) {
  return (
    ...
    B(e, 'dofollow')
      ? 'Dofollow'
      : t !== 'internal' && s.noFollowExternalLinks && !B(e, 'nofollow')
        ? My(Ei(e), s)
          ? 'Dofollow'
          : 'Nofollow'
        : !B(e, '<a') || !B(e, 'rel=')
...
function D(e, t) {
  let s = -1;
  if (!e || (!Array.isArray(e) && !e.type)) throw new Error('Expected node, not `' + e + '`');
  if (typeof e.value == 'string') return e.value;
  const n = (Array.isArray(e) ? e : e.children) || [];
  if (n.length === 1 && 'value' in n[0]) return n[0].value;
  const i = [];
  for (; ++s < n.length; ) i[s] = D(n[s], t);
  return i.join(t || '');
}
...
function Gy(e, t, s) {
  ...
  if (!Hy.call(e, 'length')) throw new Error('Iterate requires that |this| has a `length`');
...
function M(e) {
  return t;
  function t(n) {
    if (!n || !n.children) throw new Error('Missing children in `parent` for `modifier`');
    Gy(n.children, s, n);
  }
  function s(n, i) {
    return e(n, i, this);
...
const Vy = M(
     ...
     */
    function (e, t, s) {
      if ((e.type !== 'SymbolNode' && e.type !== 'PunctuationNode') || D(e) !== '&') return;
      const n = s.children,
        i = n[t + 1];
      if (!((t > 0 && n[t - 1].type === 'WordNode') || !(i && i.type === 'WordNode')))
        return (
          ...
          i.position && e.position && (i.position.start = e.position.start),
          t - 1
        );
    }
  ),
    ...
    function (e, t, s) {
      if (t > 0 && (e.type === 'SymbolNode' || e.type === 'PunctuationNode')) {
        ...
        if (i && i.type === 'WordNode') {
          ...
          for (; n[++r]; ) {
            const c = n[r];
            if (c.type === 'WordNode') o.push(...a, ...c.children), (a = []);
  ...
  ab = M(
    ...
    function (e, t, s) {
      ...
      if (
        i &&
        i.type === 'WordNode' &&
        (e.type === 'SymbolNode' || e.type === 'PunctuationNode') &&
        D(e) === '/'
      ) {
        const r = D(i);
        let o = e;
        ...
        const l = n[t + 1];
        if (
          (l && l.type === 'WordNode' && ((u = D(l)), (o = l), a.push(...l.children), c++),
          r.length < 3 && (!u || u.length < 3))
        )
          return (
            i.children.push(...a),
            n.splice(t, c),
            i.position && o.position && (i.position.end = o.position.end),
            t
          );
      }
    }
        ...
        if (
          ...
          for (; n.children[--i]; ) {
            ...
            if (i % 2 === 0) {
              ...
              if (i < n.children.length - 2) break;
              return;
            }
          }
          if (!r)
            return (
              ...
              n.children.push(e),
              n.position && e.position && (n.position.end = e.position.end),
              t
            );
        }
      }
...
function gt(e) {
  ...
  function t(s) {
    ...
    let i = -1;
    if (!n) throw new Error('Missing children in `parent` for `visit`');
    for (; ++i in n; ) e(n[i], i, s);
  }
}
const es = gt(
  /**
  ...
  function (e, t, s) {
    ...
    e.position &&
      ...
      (ln(s), (s.position.start = e.position.start)),
      e.position &&
        t === n.length - 1 &&
        (!s.position || !s.position.end) &&
        (ln(s), (s.position.end = e.position.end));
  }
);
function ln(e) {
...
const ub = M(
    ...
    function (e, t, s) {
      if ('children' in e) {
        let n = -1;
        for (; e.children[++n]; ) if (e.children[n].type === 'WordNode') return;
        const i = s.children[t - 1];
        if (i && 'children' in i)
          return (
            i.children.push(...e.children),
            s.children.splice(t, 1),
            i.position && e.position && (i.position.end = e.position.end),
            t
          );
    ...
    function (e, t, s) {
      if ('children' in e && e.children.length > 0 && t > 0) {
        ...
        if (
          n &&
          n.type === 'SentenceNode' &&
          (i.type === 'SymbolNode' || i.type === 'PunctuationNode') &&
          Zy.test(D(i))
        )
          return (
            e.children.shift(),
            n.children.push(i),
            i.position && n.position && (n.position.end = i.position.end),
            r && r.position && e.position && (e.position.start = r.position.start),
            t - 1
          );
      }
    }
            ...
            if (o.type === 'WordNode')
              return tb.test(D(o))
                ? (n.children.push(...i),
                  ...
                  t)
                : void 0;
            if (o.type === 'SymbolNode' || o.type === 'PunctuationNode') return;
          }
        }
      }
    }
          ...
          if (i && i.type === 'WordNode' && gb.test(D(i).toLowerCase())) {
            ...
            if (r && r.type === 'SentenceNode')
              return (
                ...
                s.children.splice(t + 1, 1),
                r.position && e.position && (e.position.end = r.position.end),
                t - 1
              );
          }
        }
      ...
      if ('children' in e) {
        ...
        for (; e.children[--n]; ) {
          ...
          if (o && o.type === 'WordNode') {
            ...
            if (a && c && a.type === 'WhiteSpaceNode' && D(c) === '.') continue;
            ...
            a &&
              a.type === 'WordNode' &&
              (e.children.splice(n, 1),
              a.children.unshift(r),
              r.position && a.position && (a.position.start = r.position.start));
        }
      }
    }
  ),
  ...
  Bi = M(
     ...
     */
    function (e, t, s) {
      if ('children' in e && e.children.length === 0) return s.children.splice(t, 1), t;
    }
  );
class Se {
  /**
   ...
   */
  tokenizeRoot(t) {
    const s = this.tokenizeParagraph(t),
      n = {
        type: 'RootNode',
        children: dn(s, 'WhiteSpaceNode', Jy),
      };
    let i = -1;
    for (; this.tokenizeRootPlugins[++i]; ) this.tokenizeRootPlugins[i](n);
    return n;
  }
  /**
   ...
   */
  tokenizeParagraph(t) {
    const s = this.tokenizeSentence(t),
      n = {
        type: 'ParagraphNode',
        children: dn(s, 'PunctuationNode', xi),
      };
    let i = -1;
    for (; this.tokenizeParagraphPlugins[++i]; ) this.tokenizeParagraphPlugins[i](n);
    return n;
  }
  /**
   * Parse as a sentence.
  ...
  tokenizeSentence(t) {
    ...
    let i = -1;
    for (; this.tokenizeSentencePlugins[++i]; ) this.tokenizeSentencePlugins[i](n);
    return n;
  }
  /**
  ...
  tokenize(t) {
    ...
    for (; r < t.length; ) {
      ...
      i < r &&
        ...
        p &&
        !(
          a === p && // Words or white space continue.
          (a === 'WordNode' ||
            a === 'WhiteSpaceNode' || // Same character of punctuation or symbol also continues.
            l === c || // Surrogates of  punctuation or symbol also continue.
            sb.test(l))
        ) &&
        (s.push(u(a, t.slice(i, r))), (i = r), (o = { ...n })),
        l === '\r' ||
        (l ===
          `
` &&
...
Se.prototype.tokenizeSentencePlugins = [Vy, Yy, ob, ab, cb, es];
Se.prototype.tokenizeParagraphPlugins = [ub, lb, db, pb, hb, fb, mb, Si, $i, yb, Bi, es];
Se.prototype.tokenizeRootPlugins = [Si, $i, Bi, es];
function dn(e, t, s) {
  const n = [];
  let i = -1,
    r = 0;
...
class ts extends Se {}
ts.prototype.tokenizeSentencePlugins = [gt(Fb), ...Se.prototype.tokenizeSentencePlugins];
ts.prototype.tokenizeParagraphPlugins = [M(kb), ...Se.prototype.tokenizeParagraphPlugins];
const bb = new RegExp(
  ...
  Db = new RegExp('^(o|ol)$'),
  wb = new RegExp('^(im|er|em|cause|twas|tis|twere|\\d\\ds?)$'),
  pn = /^['\u2019]$/;
function kb(e, t, s) {
  if ('children' in e && e.children) {
    const n = e.children[e.children.length - 1],
      i = e.children[e.children.length - 2];
    if (n && n.type === 'PunctuationNode' && D(n) === '.' && i && i.type === 'WordNode') {
      ...
      if (bb.test(r.toLowerCase()) || vb.test(r)) {
        ...
        if (o && o.type === 'SentenceNode')
          return (
            e.children.push(...o.children),
            s.children.splice(t + 1, 1),
            o.position && e.position && (e.position.end = o.position.end),
            t - 1
          );
      }
    }
  ...
  if (e.type === 'PunctuationNode' || e.type === 'SymbolNode') {
    ...
    if (r === '/') {
      ...
      o &&
        ...
        (n.splice(t, 1),
        o.children.push(e),
        o.position && e.position && (o.position.end = e.position.end));
    } else if (pn.test(r)) {
      const o = n[t - 1];
      if (
        t > 2 &&
        t < i - 1 &&
        o.type === 'WordNode' &&
        n[t - 2].type === 'WhiteSpaceNode' &&
        n[t + 1].type === 'WhiteSpaceNode' &&
        Db.test(D(o).toLowerCase())
      ) {
        n.splice(t, 1),
          o.children.push(e),
          o.position && e.position && (o.position.end = e.position.end);
      ...
      if (
        t !== i - 1 &&
        n[t + 1].type === 'WordNode' &&
        (t === 0 || n[t - 1].type !== 'WordNode')
      ) {
        const a = n[t + 1],
          c = D(a).toLowerCase(),
          u = n[t + 2];
        a.type === 'WordNode' && wb.test(c)
          ? (n.splice(t, 1),
            a.children.unshift(e),
            a.position && e.position && (a.position.start = e.position.start))
          : a.type === 'WordNode' &&
            c === 'n' &&
            u &&
            u.type === 'PunctuationNode' &&
            pn.test(D(u)) &&
            (n.splice(t, 1),
            n.splice(t + 1, 1),
            a.children.unshift(e),
            a.children.push(u),
            a.position &&
              (e.position && (a.position.start = e.position.start),
              u.position && (a.position.end = u.position.end)));
      }
    }
  }
}
const Ab = (e) => {
  if (((e = se([fe, me, Yt, qe, pt, fi])(e)), e === '')) return 0;
...
`
    ...
    e.indexOf('<option') !== -1 &&
      ((e = e.replace(/\s*<option/g, '<option')), (e = e.replace(/<\/option>\s*/g, '</option>'))),
    e.indexOf('</object>') !== -1 &&
      ((e = e.replace(/(<object[^>]*>)\s*/g, '$1')),
      (e = e.replace(/\s*<\/object>/g, '</object>')),
      (e = e.replace(/\s*(<\/?(?:param|embed)[^>]*>)\s*/g, '$1'))),
    (e.indexOf('<source') !== -1 || e.indexOf('<track') !== -1) &&
      ((e = e.replace(/([<\[](?:audio|video)[^>\]]*[>\]])\s*/g, '$1')),
      (e = e.replace(/\s*([<\[]\/(?:audio|video)[>\]])/g, '$1')),
      (e = e.replace(/\s*(<(?:source|track)[^>]*>)\s*/g, '$1'))),
    e.indexOf('<figcaption') !== -1 &&
      ((e = e.replace(/\s*(<figcaption[^>]*>)/, '$1')),
      (e = e.replace(/<\/figcaption>\s*/, '</figcaption>'))),
    (e = e.replace(
      /\n\n+/g,
      `
...
`;
    ...
    (e = e.replace(/<p>\s*<\/p>/g, '')),
    (e = e.replace(/<p>([^<]+)<\/(div|address|form)>/g, '<p>$1</p></$2>')),
    (e = e.replace(new RegExp('<p>\\s*(</?' + n + '[^>]*>)\\s*</p>', 'g'), '$1')),
    (e = e.replace(/<p>(<li.+?)<\/p>/g, '$1')),
    (e = e.replace(/<p><blockquote([^>]*)>/gi, '<blockquote$1><p>')),
    (e = e.replace(/<\/blockquote><\/p>/g, '</p></blockquote>')),
    (e = e.replace(new RegExp('<p>\\s*(</?' + n + '[^>]*>)', 'g'), '$1')),
    (e = e.replace(new RegExp('(</?' + n + '[^>]*>)\\s*</p>', 'g'), '$1')),
    t &&
      ((e = e.replace(/<(script|style).*?<\/\\1>/g, (r) =>
        r[0].replace(/\n/g, '<WPPreserveNewline />')
      )),
...
`
    ...
    (e = e.replace(new RegExp('(</?' + n + '[^>]*>)\\s*<br />', 'g'), '$1')),
    (e = e.replace(/<br \/>(\s*<\/?(?:p|li|div|dl|dd|dt|th|pre|td|ul|ol)[^>]*>)/g, '$1')),
    (e = e.replace(/\n<\/p>$/g, '</p>')),
    s.forEach((r) => {
      const [o, a] = r;
      e = e.replace(o, a);
...
const Ke = (e) => e.replace(/<style[^>]*>([\S\s]*?)<\/style>/gim, ''),
  We = (e) => e.replace(/<script[^>]*>([\S\s]*?)<\/script>/gim, ''),
  ss = (e) => e.replace(/[‘’‛`]/g, "'").replace(/[“”〝〞〟‟„]/g, '"'),
  Mb = (e) => e.replace(/&nbsp;/g, ' ').replace(/\s+/g, ' ');
function zi(e) {
  return R(e) ? '' : se([Mb, Ke, We, me, pt, qe, ss])(e);
}
function ht(e) {
  return R(e) ? '' : se([Ke, We, fe, me, pt, qe, ss])(e);
}
function ns(e) {
  return R(e) ? '' : se([fe, qe])(e);
}
function qb(e) {
  return e
    .replace(/&nbsp;|&#160;/gi, ' ')
...
function Nb(e) {
  return R(e) ? '' : se([Ke, We, fe, me, qb])(e);
}
function Kb(e) {
  return R(e) ? '' : se([Ke, We, fe, me])(e);
}
const Wb = (e, t) => {
    const s = /<p(?:[^>]+)?>(.*?)<\/p>/gi,
      n = [];
    let i;
    for (; (i = s.exec(e)) !== null; ) n.push(i);
    return Me(n, (r) => (t ? ht(r[1]) : r[1]));
  },
  Ti = (e, t) => {
    (e = se([Yt, me, Lb])(e)), (t = t || !1);
    const s = Wb(e, t);
...
class Vb extends A {
  ...
  newResult(t) {
    return new C()
      ...
      .setEmpty(t.__('Add a few images and/or videos to make your content appealing.', 'rank-math'))
      .setTooltip(
        t.__(
  ...
  getResult(t, s, n) {
    ...
    return t.hasText()
      ? (i.setScore(this.calculateScore(t)).setText(this.translateScore(i, n)), i)
      : (t.hasThumbnail() && i.setScore(1).setText(this.translateScore(i, n)), i);
  }
  /**
  ...
  calculateScore(t) {
    let s = 0;
    return (
      (s += this.calculateImagesScore(this.getImages(t))),
      (s += this.calculateVideosScore(this.getVideos(t.getText()))),
      Math.min(this.getScore(), s)
    );
  }
  /**
   * Get analysis max score.
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('Your content contains images and/or video(s).', 'rank-math')
      : s.__('You are not using rich media like images or videos.', 'rank-math');
  }
  /**
   * Get all the images.
   *
  ...
  getVideosFromIframe(t) {
    return {
      count: this.match(t, '<iframe(?:[^>]+)?>').filter((n) =>
        this.hasVideoUrl(n) ? ((t = t.replace(n, '')), !0) : !1
      ).length,
      text: t,
    };
  }
  ...
  getVideosFromVideoTag(t) {
    return {
      count: this.match(t, '<video(?:[^>]+)?>').filter((n) =>
        this.hasVideoUrl(n) ? ((t = t.replace(n, '')), !0) : !1
      ).length,
      text: t,
    };
...
class Yb extends A {
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(
        t.__('Add short and concise paragraphs for better readability and UX.', 'rank-math')
      )
      .setTooltip(
        t.__(
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      o = s
        .getResearch('getParagraphs')(t.getText())
        .some((a) => 120 < a.wordCount);
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('You are using short paragraphs.', 'rank-math')
      : s.__('At least one paragraph is long. Consider using short paragraphs.', 'rank-math');
  }
}
const ke = {
  ...
  productReview:
    'https://rankmath.com/kb/woocommerce-product-schema/?utm_source=Plugin&utm_medium=Content%20Analysis%20Single%20Test%20KB&utm_campaign=WP#reviews',
};
class Zb extends A {
  /**
   * Create new analysis result instance.
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Use Table of Content to break-down your text.', 'rank-math'))
      .setTooltip(
        t.__(
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      r = this.configs.assessor.hasTOCPlugin;
...
class i3 extends A {
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Keyword Density is 0. Aim for around 1% Keyword Density.', 'rank-math'))
      .setTooltip(
        t.__(
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      o = s.getResearch('wordCount')(t.getTextLower()),
      a = t.get('keywords');
    if (o === !1 || o === 0 || ze(a)) return i;
    const c = new RegExp(Me(a, Pi).join('|'), 'gi'),
      u = (ns(t.getText()).match(c) || []).length,
      l = w('rankMath_analysis_keywordDensity', ((u / o) * 100).toFixed(2), u),
      p = this.calculateScore(l);
    return i.setScore(p.score).setText(n.sprintf(this.translateScore(p.type, n), l, u)), i;
  }
  /**
   * Checks whether paper meet analysis requirements.
   *
  ...
  getBoundaries() {
    return w('rankMath_analysis_keywordDensity_score', {
      fail: 0,
      fair: 2,
      good: 3,
      best: 6,
...
class r3 extends A {
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Use Focus Keyword at the beginning of your content.', 'rank-math'))
      .setTooltip(
        t.__(
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('Focus Keyword appears in the first 10% of the content.', 'rank-math')
      : s.__("Focus Keyword doesn't appear at the beginning of your content.", 'rank-math');
  }
}
class o3 extends A {
  /**
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Use Focus Keyword in the content.', 'rank-math'))
      .setTooltip(
        t.__(
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('Focus Keyword found in the content.', 'rank-math')
      : s.__("Focus Keyword doesn't appear in the content.", 'rank-math');
  }
}
class a3 extends A {
  /**
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Add an image with your Focus Keyword as alt text.', 'rank-math'))
      .setTooltip(
        t.__(
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      r = t.getLower('thumbnailAlt');
    let o = t.getLower('keyword');
    if (o === r) return i.setScore(this.calculateScore(!0)).setText(this.translateScore(i, n)), i;
    o = Fi(o.split(' ')).join(' ');
    const a = o.replace(/[.*+?^${}()|[\]\\]/g, '\\$&').replace(/ /g, '.*');
    let c = new RegExp(`<img[^>]*alt=['"][^'"]*` + a + `[^'"]*['"]`, 'gi');
    return t.getTextLower().match(c) !== null || B(t.getLower('thumbnailAlt'), o)
      ? (i.setScore(this.calculateScore(!0)).setText(this.translateScore(i, n)), i)
      : ((c = new RegExp('\\[gallery( [^\\]]+?)?\\]', 'ig')),
        t.getTextLower().match(c) !== null &&
          i
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('Focus Keyword found in image alt attribute(s).', 'rank-math')
      : s.__('Focus Keyword not found in image alt attribute(s).', 'rank-math');
  }
}
class c3 extends A {
  /**
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Add Focus Keyword to your SEO Meta Description.', 'rank-math'))
      .setTooltip(
        t.__('Make sure the focus keyword appears in the SEO description too.', 'rank-math')
      );
  }
  /**
   * Executes the assessment and return its result
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      r = B(t.getLower('description'), t.getLower('keyword'));
    return i.setScore(this.calculateScore(r)).setText(this.translateScore(i, n)), i;
  }
  /**
   * Checks whether paper meet analysis requirements.
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('Focus Keyword used inside SEO Meta Description.', 'rank-math')
      : s.__('Focus Keyword not found in your SEO Meta Description.', 'rank-math');
  }
}
class u3 extends A {
  /**
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Use Focus Keyword in the URL.', 'rank-math'))
      .setTooltip(
        t.__('Include the focus keyword in the slug (permalink) of this post.', 'rank-math')
      );
  }
  /**
   * Executes the assessment and return its result
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      r = t.getUrl().replace(/[-_]/gi, '-'),
      o = B(r, t.getKeywordPermalink(s)) || B(r, t.getPermalinkWithStopwords(s));
    return i.setScore(this.calculateScore(o)).setText(this.translateScore(i, n)), i;
  }
  /**
   * Checks whether paper meet analysis requirements.
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('Focus Keyword used in the URL.', 'rank-math')
      : s.__('Focus Keyword not found in the URL.', 'rank-math');
  }
}
class l3 extends A {
  /**
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Use Focus Keyword in subheading(s) like H2, H3, H4, etc..', 'rank-math'))
      .setTooltip(
        t.__(
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      r = new RegExp('<h[2-6][^>]*>.*' + Pi(t.getLower('keyword')) + '.*</h[2-6]>', 'gi'),
      o = t.getTextLower().match(r) !== null;
    return i.setScore(this.calculateScore(o)).setText(this.translateScore(i, n)), i;
  }
  /**
   * Checks whether paper meet analysis requirements.
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('Focus Keyword found in the subheading(s).', 'rank-math')
      : s.__('Focus Keyword not found in subheading(s) like H2, H3, H4, etc..', 'rank-math');
  }
}
class d3 extends A {
  /**
  ...
  newResult(t, s) {
    return new C()
      .setMaxScore(this.getScore(s.getShortLocale()))
      .setEmpty(t.__('Add Focus Keyword to the SEO title.', 'rank-math'))
      .setTooltip(
        t.__('Make sure the focus keyword appears in the SEO post title too.', 'rank-math')
      );
  }
  /**
   * Executes the assessment and return its result
   ...
   */
  getResult(t, s, n) {
    const i = this.newResult(n, t),
      r = B(t.getLower('title'), t.getLower('keyword'));
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__("Hurray! You're using Focus Keyword in the SEO Title.", 'rank-math')
      : s.__('Focus Keyword does not appear in the SEO title.', 'rank-math');
  }
}
class p3 extends A {
  constructor() {
  ...
  newResult(s) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(s.__('Set a Focus Keyword for this content.', 'rank-math'));
  }
  /**
   * Executes the assessment and return its result
   *
   ...
   */
  getResult(s, n, i) {
    const r = this.newResult(i),
      o = s.getLower('keyword').trim();
    return R(this.keywordsChecked[o])
      ? ((this.keywordsChecked[o] = !0),
        r.setText(i.__('We are searching in database.', 'rank-math')),
        r)
      : ((r.has = this.keywordsChecked[o]),
        r.setText(this.translateScore(o, this.keywordsChecked[o], i)),
        jy('rankMath_analysis_keywordUsage_updated', o, r),
        r);
  }
  /**
   * Checks whether paper meet analysis requirements.
  ...
  translateScore(s, n, i) {
    return n
      ? i.__("You haven't used this Focus Keyword before.", 'rank-math')
      : i.sprintf(
          ...
          '<a target="_blank" href="' +
            this.changeKeywordInLink(s) +
            '">' +
            i.__('already used', 'rank-math') +
            '</a>'
        );
  }
  /**
  ...
  changeKeywordInLink(s) {
    return this.configs.assessor.focusKeywordLink
      .replace('%focus_keyword%', s)
      .replace('%post_type%', this.configs.objectType)
      .replace('%yaxonomy%', this.configs.objectType);
  }
}
class g3 extends A {
  /**
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(this.getFilteredText('emptyContent', t))
  ...
  getResult(t, s, n) {
    ...
    return (
      o === !1 ||
        o === 0 ||
        i.setScore(this.calculateScore(o)).setText(n.sprintf(this.translateScore(i, n), o)),
      i
    );
  }
  /**
  ...
  getBoundaries() {
    return w('rankMath_analysis_contentLength_boundaries', {
      recommended: {
        boundary: 2500,
        score: 8,
      },
...
class h3 extends A {
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('URL unavailable. Add a short URL.', 'rank-math'))
      .setTooltip(t.__('Permalink should be at most 75 characters long.', 'rank-math'));
  }
  /**
   * Executes the assessment and return its result
   *
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      r = t.getUrl().length;
    return i.setScore(this.calculateScore(r)).setText(n.sprintf(this.translateScore(i, n), r)), i;
  }
  /**
   * Checks whether paper meet analysis requirements.
   *
...
class f3 extends A {
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Link out to external resources.', 'rank-math'))
      .setTooltip(
        t.__('It helps visitors read more about a topic and prevents pogosticking.', 'rank-math')
      );
  }
  /**
   * Executes the assessment and return its result
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      o = s.getResearch('getLinkStats')(t.getText(), t.configs);
    return (
      o.total === 0 ||
        i
          .setScore(this.calculateScore(0 < o.externalTotal))
          .setText(n.sprintf(this.translateScore(i, n), o.externalTotal)),
      i
    );
  }
  /**
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('Great! You are linking to external resources.', 'rank-math')
      : s.__('No outbound links were found. Link out to external resources.', 'rank-math');
  }
}
class m3 extends A {
  /**
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Add internal links in your content.', 'rank-math'))
      .setTooltip(t.__('Internal links decrease your bounce rate and improve SEO.', 'rank-math'));
  }
  /**
   * Executes the assessment and return its result
   *
  ...
  getResult(t, s, n) {
    ...
    return (
      o.total === 0 ||
        i
          .setScore(this.calculateScore(0 < o.internalTotal))
          .setText(n.sprintf(this.translateScore(i, n), o.internalTotal)),
      i
    );
  }
  /**
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('You are linking to other resources on your website which is great.', 'rank-math')
      : s.__("We couldn't find any internal links in your content.", 'rank-math');
  }
}
class y3 extends A {
  /**
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Add DoFollow links pointing to external resources.', 'rank-math'))
      .setTooltip(
        t.__(
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      o = s.getResearch('getLinkStats')(t.getText(), t.configs);
    return o.total === 0
      ? (i.setText(n.__('Add DoFollow links pointing to external resources.', 'rank-math')), i)
      : (i
          .setScore(this.calculateScore(0 < o.externalDofollow))
          .setText(n.sprintf(this.translateScore(i, n), o.externalTotal)),
        i);
  }
  /**
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('At least one external link with DoFollow found in your content.', 'rank-math')
...
class b3 extends A {
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Add a number to your title to improve CTR.', 'rank-math'))
      .setTooltip(
        t.__(
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('You are using a number in your SEO title.', 'rank-math')
      : s.__("Your SEO title doesn't contain a number.", 'rank-math');
  }
}
var v3 = Le,
  D3 = Xt,
...
class A3 extends A {
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      r = t.getLower('title').split(' '),
      o = this.configs.assessor.powerWords.filter((c) => F3(r, c) >= 0),
      a = 0 < o.length;
    return (
      i.setScore(this.calculateScore(a)).setText(n.sprintf(this.translateScore(i, n), o.length)), i
    );
  }
  /**
   * Checks whether paper meet analysis requirements.
...
var Ye = {
  ...
  lye = {
    ...
    addLanguage: function (e, t) {
      if (!t.labels) throw new Error('language.labels must be defined!');
    ...
    applyScoringStrategy: function (e, t, s, n) {
      var i = this.getLanguage(e),
        r = i.scoringStrategy || dye;
...
class fye extends A {
  ...
  getResult(t, s, n) {
    const i = this.newResult(n, t),
      o = new gye().analyze(t.getLower('title'), hye).score;
    return i.setScore(this.calculateScore(o)).setText(this.translateScore(i, n)), i;
  }
  /**
   * Checks whether paper meet analysis requirements.
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('Your title has a positive or a negative sentiment.', 'rank-math')
      : s.sprintf(
...
class mye extends A {
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Use the Focus Keyword near the beginning of SEO title.', 'rank-math'))
      .setTooltip(
        t.__(
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      r = t.getLower('title'),
      o = r.indexOf(t.getLower('keyword')),
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('Focus Keyword used at the beginning of SEO title.', 'rank-math')
      : s.__("Focus Keyword doesn't appear at the beginning of SEO title.", 'rank-math');
  }
}
function yye(e, t, s, n) {
  var i = -1,
    r = e == null ? 0 : e.length;
  for (n && r && (s = e[++i]); ++i < r; ) s = t(s, e[i], i, e);
  return s;
}
var bye = yye,
  vye = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g;
function Dye(e) {
  return e.match(vye) || [];
}
var wye = Dye,
  kye = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;
function Fye(e) {
  return kye.test(e);
}
var Aye = Fye,
  ...
  fn = '(?:' + Ui + '|' + Hi + ')',
  Mye = '(?:' + De + '|' + Hi + ')',
  mn = '(?:' + Ki + '(?:d|ll|m|re|s|t|ve))?',
  yn = '(?:' + Ki + '(?:D|LL|M|RE|S|T|VE))?',
  Yi = Iye + '?',
  Zi = '[' + Tye + ']?',
  qye = '(?:' + Lye + '(?:' + [Oye, Gi, Vi].join('|') + ')' + Zi + Yi + ')*',
  Nye = '\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])',
  Kye = '\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])',
  Wye = Zi + Yi + qye,
  Uye = '(?:' + [Pye, Gi, Vi].join('|') + ')' + Wye,
  Hye = RegExp(
    [
      De + '?' + Ui + '+' + mn + '(?=' + [hn, De, '$'].join('|') + ')',
...
function Qye(e, t, s) {
  return (
    (e = Jye(e)), (t = s ? void 0 : t), t === void 0 ? (Zye(e) ? Xye(e) : Yye(e)) : e.match(t) || []
  );
}
var ebe = Qye,
  tbe = bye,
...
function pbe(e) {
  return function (t) {
    t = dbe(t);
    var s = ube(t) ? lbe(t) : void 0,
      n = s ? s[0] : t.charAt(0),
      i = s ? cbe(s, 1).join('') : t.slice(1);
    return n[e]() + i;
  };
}
var gbe = pbe,
...
class wbe extends A {
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('Reviews are disabled on this Product.', 'rank-math'));
  }
  /**
   * Executes the assessment and return its result
   *
  ...
  getResult(t, s, n) {
    const i = this.newResult(n),
      r = this.configs.assessor.isReviewEnabled;
    return i.setScore(this.calculateScore(r)).setText(this.translateScore(i, n)), i;
  }
  /**
   * Checks whether paper meet analysis requirements.
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('Reviews are enabled for this Product. Good Job!', 'rank-math')
      : s.__('Reviews are disabled on this Product.', 'rank-math');
  }
}
class kbe extends A {
  /**
  ...
  newResult(t) {
    return new C()
      .setMaxScore(this.getScore())
      .setEmpty(t.__('You are not using the Product Schema for this Product.', 'rank-math'));
  }
  /**
   * Executes the assessment and return its result
   *
  ...
  translateScore(t, s) {
    return t.hasScore()
      ? s.__('You are using the Product Schema for this Product', 'rank-math')
      : s.__('You are not using the Product Schema for this Product.', 'rank-math');
  }
}
class Fbe {
  /**
  ...
  constructor(t) {
    (this.options = t),
      (this.researcher = le(t, 'researcher') ? t.researcher : new Ri()),
      this.setI18n(le(t, 'i18n') ? t.i18n : void 0),
      this.setAnalyses();
  }
  /**
  ...
  generateResults(t, s) {
    return new Promise((n) => {
      (this.results = {}),
        this.researcher.setPaper(s),
        Oe(t, (i, r) => {
          i.setConfig(s.configs);
          const o = i.isApplicable(s, this.researcher)
            ? i.getResult(s, this.researcher, this.i18n)
            : i.newResult(this.i18n, s);
   ...
   */
  setI18n(t) {
    if (R(t)) throw new Error('The assessor requires an i18n object.');
    this.i18n = t;
  }
  /**
   * Set analyses.
  ...
  setAnalyses() {
    (this.defaultAnalyses = {
      ...
      le(this.options, 'analyses') &&
        !R(this.options.analyses) &&
        (this.analyses = As(this.defaultAnalyses, this.options.analyses));
  }
}
var Abe = Ie,
  Cbe = jn,
...
function Pbe(e) {
  var t = [];
  if (e != null) for (var s in Object(e)) t.push(s);
  return t;
}
var jbe = Pbe,
  Ibe = te,
  ...
  qbe = Mbe.hasOwnProperty;
function Nbe(e) {
  if (!Ibe(e)) return Lbe(e);
  var t = Obe(e),
    s = [];
  for (var n in e) (n == 'constructor' && (t || !qbe.call(e, n))) || s.push(n);
  return s;
}
var Kbe = Nbe,
  Wbe = $n,
...
var Vbe = Gbe,
  ...
  Xbe = Vbe,
  Ji = Object.prototype,
  Qbe = Ji.hasOwnProperty,
  e3e = Ybe(function (e, t) {
    e = Object(e);
    var s = -1,
      n = t.length,
      i = n > 2 ? t[2] : void 0;
...
const Rt = {},
  ...
  ce = (e) => {
    if (R(e)) return e;
    for (const t in Rt) e = e.replace(Rt[t], t);
    return e;
  },
  s3e = () => ({
    importConfirm:
      "Are you sure you want to import settings into Rank Math? Don't worry, your current configuration will be saved as a backup.",
    restoreConfirm:
      'Are you sure you want to restore this backup? Your current configuration will be overwritten.',
    ...
    assessor: {
      ...
      focusKeywordLink:
        'http://localhost/baeminrider/wp-admin/edit.php?focus_keyword=%focus_keyword%&post_type=%post_type%',
      registrationUrl: 'http://localhost/baeminrider/wp-admin/admin.php?page=rank-math&view=help',
      hasOnpageAnalysis: !0,
      hasBreadcrumb: !0,
      isUserEdit: !1,
      socialPanelLink:
        'http://localhost/baeminrider/wp-admin/admin.php?page=rank-math-options-titles#setting-panel-social',
    },
    richSnippets: {
    ...
    customFields: {
      ...
      rank_math_robots:
        'a:4:{i:0;s:5:"index";i:1;s:8:"nofollow";i:2;s:9:"noarchive";i:3;s:9:"nosnippet";}',
      ...
      rank_math_snippet_jobposting_address:
        'a:5:{s:13:"streetAddress";s:12:"House # C269";s:15:"addressLocality";s:15:"Lukhnow Society";s:13:"addressRegion";s:5:"Sindh";s:10:"postalCode";s:5:"74900";s:14:"addressCountry";s:8:"Pakistan";}',
      rank_math_snippet_recipe_instructions:
        'a:2:{i:0;a:2:{s:4:"name";s:0:"";s:4:"text";s:0:"";}i:1;a:2:{s:4:"name";s:0:"";s:4:"text";s:0:"";}}',
...
class n3e {
   ...
   */
  setKeyword(t) {
    (this.args.keyword = ce(t)),
      (this.args.keywordLower = t.toLowerCase()),
   ...
   */
  setKeywords(t) {
    this.args.keywords = dt(Me(t, (s) => ce(s).toLowerCase()));
  }
  /**
  ...
  setText(t) {
    (this.text = t || ''),
      (this.textLower = ''),
      t !== '' && ((this.text = ce(zi(t))), (this.textLower = this.text.toLowerCase()));
  }
  /**
  ...
  getKeywordPermalink(t) {
    if (this.keywordPermalink === !1) {
      const s = t.getResearch('slugify'),
        n = t.getResearch('removePunctuation'),
        i = this.getLower('keyword').split('.').join('').replace("'", '').replace(/[-_]/gi, '-');
  ...
  getKeywordCombination(t) {
    return this.hasKeyword()
      ? (this.keywordCombinations === !1 && this.generateCombinations(t), this.keywordCombinations)
      : [];
  }
  /**
  ...
  generateCombinations(t) {
    const s = this.getLower('keyword'),
      n = t.getResearch('getWords'),
      i = t.getResearch('pluralize'),
      r = t.getResearch('combinations');
    (this.keywordPlurals = /* @__PURE__ */ new Map()),
      n(s).forEach(function (o, a) {
        this.keywordPlurals.set(a, { word: o, plural: i.get(o) });
      }, this),
      (this.keywordPermalink = this.getKeywordPermalink(t)),
